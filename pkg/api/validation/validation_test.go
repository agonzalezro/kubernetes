...
func TestValidateVolumes(t *testing.T) {
	successCase := []api.Volume{
		...
		{Name: "flocker", VolumeSource: api.VolumeSource{Flocker: &api.FlockerVolumeSource{DatasetName: "name"}}},
	...
	errorCases := map[string]struct {
		...
		"empty name":                  {[]api.Volume{{Name: "badname", VolumeSource: emptyName}}, errors.ValidationErrorTypeRequired, "[0].source.flocker.datasetName", ""},
		...
		"slash in name":               {[]api.Volume{{Name: "slashinname", VolumeSource: slashInName}}, errors.ValidationErrorTypeInvalid, "[0].source.flocker.datasetName", "must not contain '/'"},
	}
